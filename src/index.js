...
// Date        Author      Change
//-----------------------------------------------------------------------
// 24.05.2020  R.Rockskool   Created
// 04.06.2020  R.Rockskool   Implemented
// 07.06.2020  R.Rockskool   CRC16 Modbus implemented
// 14.06.2020  R.Rockskool   Added Eve history for temperature and relative humidity
//-----------------------------------------------------------------------
...
export default function (cHomebridge) {
  ...
  cHomebridge.registerAccessory(name, 'homebridge-inkbird-wifi-gateway', cInkbirdWifiGateway);
}
