...
const domainFormatter = (0, tslib_1.__importStar)(require("./util/domain-formatter"));
...
class CiaoService extends events_1.EventEmitter {
     ...
     */
    updatePort(port) {
        (0, assert_1.default)(this.serviceState === "unannounced" /* UNANNOUNCED */, "Port number cannot be changed when service is already advertised!");
        this.port = port;
    }
    /**
    ...
    rebuildServiceRecords() {
        ...
        this.serviceRecords = {
            ...
            addressNSEC: new NSECRecord_1.NSECRecord(this.hostname, this.hostname, [1 /* A */, 28 /* AAAA */], 120, true), // 120 TTL of A and AAAA records
        };
    }
    /**
